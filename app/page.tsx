    ...
    <AnimatePresence>
      <div className="min-h-[100vh] sm:min-h-screen w-screen flex flex-col relative bg-peach font-inter overflow-hidden items-center">
        ...
        <motion.h1
            ...
            className="relative md:ml-[-10px] md:mb-[37px] text-[50px] font-extrabold md:text-[90px] text-[#1E2B3A] leading-[0.9] tracking-[-2px] z-[100]"
          >
          ...
          <motion.h1
            ...
            className="relative md:ml-[-10px] text-[50px]  md:mb-[37px] font-extrabold mt-5 md:text-[60px] text-[#f5f7f9] font-inter text-bg-[#f5f7f9] leading-[0.9] tracking-[-2px] z-[100]"
          >
            feed the fire.
          </motion.h1>
          <motion.div
          ...
          <div className="flex gap-[15px] mt-8 md:mt-0 flex-col md:flex-row">
            ...
            >
              <Link
                ...
                target="_blank"
                className="group rounded-xl pl-2 min-w-[180px] pr-4 py-2 text-[13px] font-semibold transition-all flex items-center justify-center bg-[#f5f7f9] text-[#1E2B3A] hover:[linear-gradient(0deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0.1)), #0D2247] no-underline flex gap-x-2  active:scale-95 scale-100 duration-75"
                style={{
            ...
            >
              <Link
                ...
                className="group rounded-xl px-4 py-2 text-[13px] font-semibold transition-all flex items-center justify-center bg-[#f5f7f9] text-[#1E2B3A] no-underline active:scale-95 scale-100 duration-75"
                style={{
                  boxShadow: "0 1px 1px #0c192714, 0 1px 3px #0c192724",
                }}
              >
          ...
          <motion.div
            ...
            className="flex flex-row justify-center items-center z-20 mx-0 mb-0 mt-5 md:mt-10 md:mb-[35px] max-w-2xl md:space-x-8"
          >
            <Link
                href="https://www.apple.com/app-store/"
                className="group rounded-xl px-4 py-2 text-[13px] font-semibold transition-all flex items-center bg-[#f5f7f9] text-[#1E2B3A] no-underline active:scale-95 scale-100 duration-75 space-x-5"
                style={{
                  boxShadow: "0 1px 1px #0c192714, 0 1px 3px #0c192724",
                }}
              >
                ...
                <div className="flex">
                  <span className="mr-2 text-center"> Download now! </span>
                </div>
              </Link>
          </motion.div>
        </main>
