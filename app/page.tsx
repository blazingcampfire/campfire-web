    ...
    <AnimatePresence>
      <div className="min-h-[100vh] sm:min-h-screen w-screen flex flex-col relative bg-peach font-inter overflow-hidden items-center">
        ...
        <motion.h1
            ...
            className="relative md:ml-[-10px] md:mb-[37px] font-extrabold text-[16vw] md:text-[90px] text-[#1E2B3A] leading-[0.9] tracking-[-2px] z-[100]"
          >
          ...
          <motion.h1
            ...
            className="relative md:ml-[-10px] md:mb-[37px] font-extrabold text-[16vw] md:text-[60px] text-[#f5f7f9] font-inter text-bg-[#f5f7f9] leading-[0.9] tracking-[-2px] z-[100]"
          >
            Feed the fire.
          </motion.h1>
          <motion.div
